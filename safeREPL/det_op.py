...
class Det_op(SafeObject):
    __safe_methods__ = ["op", "det", "oper"]
    ...
    def __init__(self,
        ...
        #try:
        #B = Matrix(ast.literal_eval(data))   # ✅ versión segura de eval
        ...
        self.output('------------------------------------------')
        self.output(C)
        self.salutation=self.get_output()
        self.B=B
        self.C=C
    ...
    def get_output(self,text=""):
        ...
        self.output_buf=""
        obuf=obuf.replace('\n',self.newline)
        #print(' obuf:',obuf,type(obuf),type(self.pretxt),self.pretxt)
